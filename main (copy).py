...
class Ui(QtWidgets.QMainWindow):
    ...
    def refreshScore(self,live_landmarks):
        ...
        self.pose_similarity_score = self.blazepose.compare_reverse(self.video_keypoint_frame,live_landmarks)
    ...
    def click_update(self):
        ...
        self.video_anim  = FuncAnimation(self.video_figure, self.video_plot_landmarks, interval=1000)
